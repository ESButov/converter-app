...
describe('ClrPage', () => {
  ...
  it('calculates drug volumes after species and weight entry', async () => {
    ...
    expect(screen.getByText('Разведение: 1 мл препарата 1 мг/мл + 9 мл 0.9% NaCl')).toBeTruthy()
  ...
  it('shows special epinephrine dilution for exotic animals under 1 kg', async () => {
    ...
    expect(screen.getByText('Разведение: 0.1 мл атропина 0.5 мг/мл + 9.9 мл 0.9% NaCl')).toBeTruthy()
